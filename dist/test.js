...
let pagRodrigo = new DetallePago_1.DetallePago(DetallePago_1.EstadoPago.Aprobado, "13/05/22", 500, tarRodrigo, 365);
let susRodrigo = new Suscripcion_1.Suscripcion(Suscripcion_1.EstadoSuscripcion.ACTIVA, [pagRodrigo]);
...
let citaRodrigo = new Cita_1.Cita("13/05/22", Cita_1.EstadoCita.CONFIRMADA, docFelipe, pacRodrigo, Cita_1.TipoCita.TELECONSULTA);
